...
class Update extends StatefulWidget {
  ...
  final String phone;
  final String input;
  const Update({Key? key, required this.code, required this.name, required this.dept, required this.phone, required this.input}) : super(key: key);
...
class _UpdateState extends State<Update> {
 //Property
  ...
  updateAction() async{
    //jsp 연결
    var url = Uri.parse(
    "http://localhost:8080/Flutter/student_update_return_flutter.jsp?code=$code&name=$name&dept=$dept&phone=$phone&input=${widget.code}"
    );
    //실행 
