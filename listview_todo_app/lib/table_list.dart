...
class _TableListState extends State<TableList> {
  ...
  void initState() {
    super.initState();
    todoList.add(TodoList(imagePath: "images/cart.png", workList: "책구매"));   //책구매 리스트 
    todoList.add(TodoList(imagePath: "images/clock.png", workList: "철수와 약속"));   //책구매 리스트 
    todoList.add(TodoList(imagePath: "images/pencil.png", workList: "스터디 준비하기"));   //책구매 리스트 
  }
  @override
    ...
    return Scaffold(
      ...
      body:  Center(
        child: ListView.builder(
          ...
          itemBuilder: (context, position) {    //내용, 위치 
            return Padding(
              ...
              child: GestureDetector(
                ...
                child: Card(
                  color: position % 2 == 0? Color.fromARGB(255, 146, 152, 196) : Color.fromARGB(255, 215, 132, 81),
                  child: Row(
                    children: [
                      Padding(
